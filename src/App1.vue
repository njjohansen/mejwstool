...
export default {
  ...
  computed: {
    ...
    queries() {
      let select =
        "&$select=Id,LastModified,Attributes/scheduled_off_block_time/Value,Attributes/scheduled_in_block_time/Value,Attributes/scheduled_off_block_time/Received,Attributes/scheduled_in_block_time/Received";
      return [
